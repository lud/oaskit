defmodule OpenApify.Web.LabTest do
      ...
      conn =
        post_reply(
          ...
          fn conn, _params ->
            ...
            assert %{dry_run: true, source: "lab"} = conn.private.open_apify.query_params
      ...
      conn =
        post_reply(
          ...
          fn conn, _params ->
            ...
            assert %{dry_run: false} = conn.private.open_apify.query_params
    ...
    test "path parameters are collected", %{conn: conn} do
      conn =
        get_reply(
          ...
          fn
            conn, _params ->
              assert %{lab: "some-lab"} == conn.private.open_apify.path_params
      ...
      conn =
        post_reply(
          ...
          fn
            conn, _params ->
              assert %{lab: "some-lab"} == conn.private.open_apify.path_params
              assert %{q: "", lab: "someprefix:xxx"} == conn.private.open_apify.query_params
