defmodule OpenApify.Web.BodyTest do
  ...
  describe "undefined operation" do
    ...
    test "nothing is validated and nothing is logged", %{conn: conn} do
      ...
      assert io =~
               "Controller OpenApify.TestWeb.BodyController has no operation defined for action :undefined_operation"
    end
  end
      ...
      conn =
        post_reply(conn, ~p"/generated/body/module-single-no-required", @no_payload, fn
          conn, _params ->
            ...
            assert nil == conn.private.open_apify.body_params
