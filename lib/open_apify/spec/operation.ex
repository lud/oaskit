defmodule OpenApify.Spec.Operation do
  ...
  JSV.defschema(%{
    ...
    properties: %{
      ...
      requestBody: %{anyOf: [OpenApify.Spec.Reference, OpenApify.Spec.RequestBody]},
      responses: OpenApify.Spec.Responses,
      callbacks: %{
        type: :object,
        additionalProperties: %{anyOf: [OpenApify.Spec.Reference, OpenApify.Spec.Callback]},
  ...
  def normalize!(data, ctx) do
    ...
    |> normalize_subs(
      callbacks: {:list, {:or_ref, OpenApify.Spec.Callback}},
      externalDocs: OpenApify.Spec.ExternalDocumentation,
      parameters: {:list, {:or_ref, OpenApify.Spec.Parameter}},
      requestBody: {:or_ref, OpenApify.Spec.RequestBody},
      responses: OpenApify.Spec.Responses,
