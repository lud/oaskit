defmodule OpenApify.JsonSchema.Formats do
  ...
  Use the `c:OpenApify.jsv_opts/0` callback to add your own formats.
  ...
  defp expect_sf_item(data, expected_type) do
    case OpenApify.Parsers.HttpStructuredField.parse_sf_item(data) do
