defmodule OpenApify do
  ...
  @type cache_key :: {:open_apify_cache, module, responses? :: boolean, variant :: term}
  ...
  `#{inspect(OpenApify.Spec)}...` namespace will be lost.
  """
  @callback spec :: map
  ...
  @callback cache({:get, key} | {:put, key, value}) :: :ok | {:ok, value} | :error
            when key: {:open_apify_cache, module, term}, value: term

  @doc """
  Returns the options that will be passed to `JSV.build/2` when building the
  spec for the implementation module.

  The default implementation delegates to `OpenApify.default_jsv_opts/0`.
  """
  ...
  def default_jsv_opts do
    [
      ...
      formats: [OpenApify.JsonSchema.Formats | JSV.default_format_validator_modules()]
    ]
  end
  ...
  defp cache_key(spec_module, opts) do
    {:open_apify_cache, spec_module, !!opts[:responses], spec_module.cache_variant()}
  end
